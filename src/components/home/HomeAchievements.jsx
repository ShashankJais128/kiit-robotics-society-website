...
function HomeAchievements() {
  return (
    <div className='bg-black bg-cover bg-bottom flex flex-col pb-10 ' style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.6)), url(${Ach})`}}>
        ...
        <h1 className='text-center text-6xl font-bold pt-6 px-10 text-yellow-500'>Achievements
        ...
        <div className='grid grid-cols-2 lg:grid-cols-3 gap-y-8 justify-items-center px-[5%] py-10'>
            <div className='w-[80%] xl:w-[70%] h-96 relative rounded-xl border-yellow-500 overflow-hidden border-4'>
