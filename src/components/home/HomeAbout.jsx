...
function HomeAbout() {
  return (
    <div
      className=" bg-black bg-cover bg-top px-8 py-10" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(${Fac})`}}>
      <div className="w-full flex flex-col md:flex-row">
        <div className="w-full md:w-1/3 items-center md:items-start space-y-1 md:space-y-9 lg:px-12 pb-8 md:py-8 flex flex-col">
        ...
        <div className="w-full md:w-2/3 grid grid-cols-1 sm:grid-cols-2 justify-items-center md:justify-items-end">
          <div className="bg-[#111111] w-[80%] sm:w-[90%] xl:w-[80%] space-y-4  my-5 px-8 py-8 flex flex-col items-center rounded-2xl border-t-4 border-b-4 border-yellow-500">
            <div className="">
