...
const CoordinatorsData = [
  {
    ...
    about:
      "lorhbe wiueg iueg ike iuekg ikuge kieh kyeh iueiyjrh 8ejyrfijy fcyhf8cjedy f8 fhoiy f8ydhf  um exexplicat quam. Minus id magni voluptatum. Beatae neque perferendis quo modi, quae nobis ullam eveniet eius praesentium incidunt eaque quibusdam commodi?",
    img: PP,
    email: "xyz@gmail.com",
  },
  {
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex justify-center w-[80%]">
          <button className="w-full" onClick={handleOnMembers}>
            <h1
              className={`text-center text-3xl sm:text-5xl md:text-6xl  border-${memVis.border} border-yellow-500 font-bold mt-6 text-yellow-500`}
            >
              Members
            </h1>
          </button>
          <button className="w-full" onClick={handleOnAlumni}>
            <h1
              className={`text-center text-3xl sm:text-5xl md:text-6xl  border-${aluVis.border} border-yellow-500 font-bold mt-6 text-yellow-500`}
            >
              Alumni
            </h1>
          </button>
