...
function Card() {
    return (
      <div>
        <div class="max-w-sm mr-8 box-border bg-black border-4 border-solid border-amber-400  rounded-3xl">
          <div>
            <img src={event} className="rounded-lg px-14 pt-8" />
          </div>
          <div class="p-5">
            <h1 className="text-center font-poppins text-3xl font-bold py-2 text-amber-400">
              PRADARSHANA 1.0
            </h1>
            <p class="mb-3 font-WorkSans text-white">
